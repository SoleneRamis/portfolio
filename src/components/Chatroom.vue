  ...
  <div class="chatroom slide">
    <div class="containerLeft">
      <div class="projectContainer">
        ...
        <div class="descContainer">
          ...
          <p class="desc">Création d'un chat en ligne au sein de Gobelins où chaque membre de la classe peut discuter avec un client différent.</p>
          <div class="techno">
            <p><span class="glif">✎</span> Vue.js</p>
            <p><span class="glif">✎</span> Socket.io</p>
    ...
    <div class="containerRight" ref="containerRight">
      ...
      <div class="previousProject">
        <div class="img">
            <img class="image" :src="'../static/imgs/chatroom/intro.png'"/>
        </div>
      </div>
    </div>
  </div>
