  ...
  <div class="louvre slide">
    <div class="containerLeft">
      <div class="projectContainer">
        ...
        <div class="descContainer">
          ...
          <p class="desc">Site web interactif autour du casque de parade de Charles VI, oeuvre appartenant à l’exposition de la Petite Galerie du Louvre: « L’archéologie en bulles ».</p>
          <div class="techno">
    ...
    <div class="containerRight" ref="containerRight">
      ...
      <div class="previousProject">
        <div class="img">
            <img class="image" :src="'../static/imgs/louvre/intro.png'"/>
        </div>
      </div>
    </div>
  </div>
