  ...
  <div class="worakls slide">
    <div class="containerLeft">
      <div class="projectContainer">
        ...
        <div class="descContainer">
          ...
          <p class="desc">Réaliser une expérience interactive réagissant à la musique avec Three.js.</p>
          <div class="techno">
            <p><span class="glif">✎</span> JavaScript</p>
            <p><span class="glif">✎</span> Three.js</p>
    ...
    <div class="containerRight" ref="containerRight">
      ...
      <div class="previousProject">
        <div class="img">
            <img class="image" :src="'../static/imgs/3DSound/intro.png'"/>
        </div>
      </div>
    </div>
  </div>
