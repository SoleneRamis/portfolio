  ...
  <div class="soundLines slide">
    <div class="containerLeft">
      <div class="projectContainer">
        ...
        <div class="descContainer">
          ...
          <p class="desc">Réaliser une expérience interactive réagissant à la musique avec canvas 2D.</p>
          <div class="techno">
            <p><span class="glif">✎</span> JavaScript</p>
            <p><span class="glif">✎</span> Canvas 2D</p>
            <p><span class="glif">✎</span> Web Audio API</p>
          </div>
        </div>
      </div>
    ...
    <div class="containerRight" ref="containerRight">
      ...
      <div class="previousProject">
        <div class="img">
            <img class="image" :src="'../static/imgs/soudlines/intro.gif'"/>
        </div>
      </div>
    </div>
  </div>
